function result = computeGrowingMeasurementModel(simResult, currentParameters, outFileName)
    ...
    mtState = simResult{1}.mtState;
    for i = 2:currentParameters.nReplicates
        mtState = [mtState; simResult{i}.mtState];
    end
    ...
    result.vm.mtState = mtState;
    mtState(isnan(mtState)) = 0;
    result.vm.mtStateNoNan = mtState;
