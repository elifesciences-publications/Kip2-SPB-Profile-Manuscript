...
%64:69
%3*ones(1,6) 
expResultsToCompare = [385:390];%[ ];%[ 45:50]% 64:69 328:333 ];% 64:69 328:333] %[45:50];%[64:69];%[45:50 64:69]; %45:50
expResultsNormalizeFrom = [35*ones(1,6) ];% 3*ones(1,6) 35*ones(1,6)];% 3*ones(1,6) 35*ones(1,6) ];
%
